...
export class OrthoCamera {
    constructor(left = -windowInfo.windowWidth / 2, right = windowInfo.windowWidth / 2, bottom = windowInfo.windowHeight / 2, top = -windowInfo.windowHeight / 2, near = 1, far = 2000) {
