...
export default class Worker {
    ...
    createObjects?: (programs: string[], objects: string[], textures: [string, number, string, number | null, boolean?][], framebuffers: string[], cameras: Camera[], textureFBOBindings:string[][]) => void;
}