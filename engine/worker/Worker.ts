...
export default class Worker {
    ...
    createObjects?: (programs: string[], objects: string[], textures: [string, number, string, number | null][], framebuffers: string[], cameras: Camera[], textureFBOBindings:string[][]) => void;
}