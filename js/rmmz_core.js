...
//-----------------------------------------------------------------------------
GameGlobal.Bitmap = Bitmap;
GameGlobal.Stage = Stage;
GameGlobal.Sprite = Sprite;
GameGlobal.Graphics = Graphics;
GameGlobal.Point = Point;
GameGlobal.Tilemap = Tilemap;
GameGlobal.Rectangle = Rectangle;
GameGlobal.TilingSprite = TilingSprite;
GameGlobal.ScreenSprite = ScreenSprite;
GameGlobal.Weather = Weather;
GameGlobal.ColorFilter = ColorFilter;
GameGlobal.Window = Window;
GameGlobal.Utils = Utils;
GameGlobal.WebAudio = WebAudio;
GameGlobal.Video = Video;
GameGlobal.Input = Input;
GameGlobal.TouchInput = TouchInput;
